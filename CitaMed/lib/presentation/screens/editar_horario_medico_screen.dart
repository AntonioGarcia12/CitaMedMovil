...
class _EditarHorarioMedicoScreenState extends State<EditarHorarioMedicoScreen> {
  ...
  Future<void> _cargarHorario() async {
    try {
      ...
      mostrarError(context, 'Error al cargar el horario: $e');
      context.go('/horarios');
    }
  }
  ...
  Future<void> _editarHorario(
    ...
    try {
      ...
      mostrarExito(context, 'Horario actualizado con éxito');
      context.go('/horarios');
    } catch (e) {
      mostrarError(context, 'Error al actualizar el horario: $e');
    } finally {
